...
function Footer(){
    return(
        <>
            <div className='min-h-[7.5rem] bg-gradient-to-t from-white to-transparent'>

            </div>
            <footer className='flex px-80 py-10 justify-between items-center bg-white'>
                <div className='flex flex-col justify-center items-center w-[12.5rem]'>
                    <img src={logo} alt="" className='w-20'/>
                    <img src={signature} alt="" className='w-[12.5rem]'/>
                </div>
                <div className='flex items-center justify-center w-[12.5rem]'>
